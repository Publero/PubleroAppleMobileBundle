...
class UsdPriceMatrix extends PriceMatrix
{
    ...
    {
        return [
            1 => 0.7, 1.4, 2.1, 2.8, 3.5, 4.2, 4.9, 5.6, 6.3, 7.0,
            ...
            38.5, 42.0, 45.5, 49.0, 52.5, 56.0, 59.5, 63.0, 66.5, 70.0,
            77.0, 84.0, 87.5, 91.0, 98.0, 105.0, 112.0, 119.0, 122.5, 126.0,
            133.0, 140.0, 147.0, 154.0, 161.0, 168.0, 175.0, 210.0, 245.0, 280.0,
            315.0, 350.0, 420.0, 490.0, 560.0, 630.0, 700.0
        ];
    }
}
